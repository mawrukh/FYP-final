...
fetch("http://10.0.2.2:3000/registerW", requestOptions)
  .then((response) => {
    if (response.ok) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('LoginW')}>
